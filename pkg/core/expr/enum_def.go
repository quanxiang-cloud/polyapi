...
func (e Enum) IsField() bool {
	return e == ValTypeField
}

// IsStringer judge if a value is able to convert to string
func (e Enum) IsStringer() bool {
	switch e {
	case ValTypeNumber, ValTypeString, ValTypeBoolean,
		ValTypeAction, ValTypeTimestamp, ValTypeField,
		ValTypeArrayString:
		return true
	}
	return false
...
func (e Enum) IsPredefineable() bool {
	switch e {
	case ValTypeNumber, ValTypeString, ValTypeBoolean,
		ValTypeAction, ValTypeTimestamp, ValTypeArrayString:
		return true
	}
	return false
}
